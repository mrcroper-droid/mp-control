...
public class DateUtils {
    ...
    public static String DATE_FORMAT_4_ATTENDANCE_EXCEPTION = "yyyy/MM/dd";

    public static String YEAR_MONTH_FORMAT = "yyyy-MM";

    public static String SALARY_YEAR_MONTH_FORMAT = "yyyy.M";

    public static String DATE_TIME_FORMAT = "yyyy-MM-dd HH:mm:ss";
    public static String DATE_TIME_FORMAT_4_ATTENDANCE = "yyyy-MM-dd HH:mm";
    public static String TIME_FORMAT_4_ATTENDANCE = "HH:mm";

    public static String DATE_FORMAT_CHINESE = "yyyy年M月";
    public static String DATE_FORMAT_CHINESE_4_REPORT = "yyyy年M月d日";
    ...
    public static String dateToStringCatchNull(Date date, String dateformat) {
        if (date == null){
            return null;
        }
        String datestr = null;
...
//        return DateUtils.addDay(DateUtils.getFirstDayOfMonth(DateUtils.addMonth(date, 1)), -1);
    ...
    public static boolean isSameDay(Date firstDate, Date lastDate) {
        return org.apache.commons.lang3.time.DateUtils.isSameDay(firstDate, lastDate);
    }
     ...
     * @return
     */
    public boolean validFromDate(Date date) {
        Calendar instance = Calendar.getInstance();
        return false;
    }

    public boolean validToDate(Date fromTime, Date toTime) {
        return toTime.after(fromTime);
    }


    public static int getMinutesByTwoDate(Date date1, Date date2) {
    ...
    public static long secondsDifference(LocalDateTime dateTime1, LocalDateTime dateTime2) {
